<x-layout>
    <section class="relative h-screen flex items-center justify-center overflow-hidden pt-16 pb-16 mb-8">
        ...
        <div class="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center container z-20">
            ...
            Infectious Diseases – Combating Global Health Threats
            </h1>
    ...
    <section>
        <div class="container services mt-16 mb-16">
            <h2 class="mb-4 text-2xl lg:text-3xl text-center font-bold font-heading wow animate__animated animate__fadeInUp">
                ...
                <span class="text-blue-800"> Infectious Diseases </span>
            </h2>
                ...
                <div class="lg:w-1/2 lg:pr-20 lg:pt-4 order-1 lg:order-0">
                    <ul class="">
                        <li class="flex -mx-4 wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                            ...
                            <div class="px-4">
                                <h3 class="my-4 text-xl font-semibold">Vaccine Development</h3>
                                <p class="text-blueGray-600 leading-loose">From preclinical studies to large-scale Phase III trials.</p>
                            </div>
                        </li>
                        <li class="flex -mx-4 wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                            ...
                            <div class="px-4">
                                <h3 class="my-4 text-xl font-semibold">Antiviral and Antibacterial Therapies</h3>
                                <p class="text-blueGray-600 leading-loose">Evaluating novel treatments for emerging pathogens.
                ...
                <div class="lg:w-1/2 lg:pr-20 lg:pt-4 order-1 lg:order-0">
                    <ul class="">
                        <li class="flex -mx-4 wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                            ...
                            <div class="px-4">
                                <h3 class="my-4 text-xl font-semibold">Pandemic Preparedness</h3>
                                <p class="text-blueGray-600 leading-loose"> Developing strategies for rapid response to future outbreaks.</p>
                            </div>
                        </li>
                        <li class="flex -mx-4 wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                            <div class="px-4">
                            ...
                            <div class="px-4 mb-4">
                                <h3 class="my-4 text-xl font-semibold">Global Trial Management</h3>
                                <p class="text-blueGray-600 leading-loose">Conducting studies in high-prevalence regions.</p>
                            </div>
                        </li>
                ...
                <div class="w-64 flex-none rounded-t lg:rounded-t-none lg:rounded-l text-center shadow-lg ">
                    <div class="block rounded-t overflow-hidden  text-center ">
                        ...
                        <div class="text-left px-3 mt-3 leading-relaxed">
                            <span class="text-md">
                            Streamlining processes to accelerate trial start-up and enrollment.
                            </span>
                        </div>
            ...
            <div class="w-64 bg-gray-100 h-48  mb-4 font-medium">
                <div class="w-64 flex-none rounded-t lg:rounded-t-none lg:rounded-l text-center shadow-lg ">
                    <div class="block rounded-t overflow-hidden  text-center ">
                        ...
                        <div class="text-left px-3 mt-3 leading-relaxed">
                            <span class="text-md">
                            Utilizing flexible trial designs to respond to evolving data and regulatory requirements.
                            </span>
                        </div>
        ...
        <div class="bg-white py-12">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-5xl lg:text-center flex flex-col justify-center items-center">
                    ...
                    <p class="mt-6 leading-relaxed text-gray-600 max-w-lg text-center">Expertise in the pathophysiology of infectious diseases and emerging treatment modalities.</p>
                </div>
                <div class="mt-16 max-w-full sm:mt-20 lg:mt-24 lg:max-w-4xl container">
                    ...
                    <div class="relative flex flex-col items-center justify-center bg-gray-100 rounded-lg p-4 mr-3 mt-3">
                            ...
                            <dd class="mt-2 text-base leading-relaxed text-gray-600 container">Successfully managed trials for COVID-19, influenza, and other infectious diseases.</dd>
                        </div>
                        <div class="relative flex flex-col items-center justify-center bg-gray-100 rounded-lg p-4 mr-3 mt-3">
                            <dt class="flex flex-col items-center justify-center text-base font-semibold leading-7 text-gray-900">
                            ...
                            <dd class="mt-2 text-base leading-relaxed text-gray-600 container">Access to diverse populations and high-prevalence regions.</dd>
                        </div>
                        <div class="relative flex flex-col items-center justify-center bg-gray-100 rounded-lg p-4 mr-3 mt-3">
                            <dt class="flex flex-col items-center justify-center text-base font-semibold leading-7 text-gray-900">
                                <div class="flex h-12 w-12 p-3 items-center justify-center rounded-lg bg-blue-800 mb-4">
                            ...
                            <dd class="mt-2 text-base leading-relaxed text-gray-600 container">Deep understanding of global regulatory requirements for infectious disease therapies.</dd>
                        </div>
