<x-layout>
    <section class="relative h-screen flex items-center justify-center overflow-hidden pt-16 pb-16 mb-8">
        <!-- Video Background -->
        <video
            autoplay
            loop
            ...
            <source src="assets/imgs/gif/neurology.mp4" type="video/mp4" />
            Your browser does not support the video tag.
        </video>

        <!-- Overlay (Optional) -->
        <div class="absolute inset-0 bg-black-500 bg-opacity-40 z-5"></div>

        <!-- Text Content -->
        <div class="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center container z-20">
            <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-8">
            Neurology – Pioneering Research for CNS Disorders
            </h1>

            <div class="lg:flex items-center justify-between text-white ">
                <!-- Left Text Section -->
                <div class="lg:w-full px-4 text-center lg:text-left">
                    ...
                    Neurological disorders, such as Alzheimer’s, Parkinson’s, and multiple sclerosis, require innovative approaches to clinical research. At [Your CRO Name], we are committed to advancing therapies that improve the lives of patients with central nervous system (CNS) conditions.
                    </p>

                </div>

                <!-- Right Video Section (Removed, as video is now in the background) -->
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="container services mt-16 mb-16">
            <h2 class="mb-4 text-2xl lg:text-3xl text-center font-bold font-heading wow animate__animated animate__fadeInUp">
                <span>Our Expertise in </span>
                <span class="text-blue-800"> Neurology </span>
            </h2>
                ...
                <div class="lg:w-1/2 lg:pr-20 lg:pt-4 order-1 lg:order-0">
                    <ul class="">
                        <li class="flex -mx-4 wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                            ...
                            <div class="px-4">
                                <h3 class="my-4 text-xl font-semibold">Neurodegenerative Diseases</h3>
                                <p class="text-blueGray-600 leading-loose">Alzheimer’s, Parkinson’s, ALS, and Huntington’s disease.</p>
                            </div>
                        </li>
                        <li class="flex -mx-4 wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                            ...
                            <div class="px-4">
                                <h3 class="my-4 text-xl font-semibold">Psychiatric Disorders</h3>
                                <p class="text-blueGray-600 leading-loose">Depression, schizophrenia, bipolar disorder, and PTSD.
                ...
                <div class="lg:w-1/2 lg:pr-20 lg:pt-4 order-1 lg:order-0">
                    <ul class="">
                        <li class="flex -mx-4 wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                            ...
                            <div class="px-4">
                                <h3 class="my-4 text-xl font-semibold">Rare Neurological Conditions</h3>
                                <p class="text-blueGray-600 leading-loose">  ALS, muscular dystrophy, and other orphan diseases.</p>
                            </div>
                        </li>
                        <li class="flex -mx-4 wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                            <div class="px-4">
                            ...
                            <div class="px-4 mb-4">
                                <h3 class="my-4 text-xl font-semibold">Pain Management</h3>
                                <p class="text-blueGray-600 leading-loose">Chronic pain, migraines, and neuropathic pain.</p>
                            </div>
                        </li>
    ...
    <section class="pt-16 pb-16 mb-8 container">
        <h2 class="mb-4 text-2xl lg:text-3xl text-center font-bold font-heading wow animate__animated animate__fadeInUp mb-16">
            ...
            <div class="w-64 bg-gray-100 h-48  mb-4 font-medium">
                <div class="w-64 flex-none rounded-t lg:rounded-t-none lg:rounded-l text-center shadow-lg ">
                    <div class="block rounded-t overflow-hidden  text-center ">
                        ...
                        <div class="text-left px-3 mt-3 leading-relaxed">
                            <span class="text-md">
                            Reducing patient burden through decentralized trials and digital health tools.
                            </span>
                        </div>
            ...
            <div class="w-64 bg-gray-100 h-48  mb-4 font-medium">
                <div class="w-64 flex-none rounded-t lg:rounded-t-none lg:rounded-l text-center shadow-lg ">
                    <div class="block rounded-t overflow-hidden  text-center ">
                        ...
                        <div class="text-left px-3 mt-3 leading-relaxed">
                            <span class="text-md">
                            Utilizing neuroimaging, EEG, and biomarkers for accurate disease assessment.
                            </span>
                        </div>
                ...
                <div class="w-64 flex-none rounded-t lg:rounded-t-none lg:rounded-l text-center shadow-lg ">
                    <div class="block rounded-t overflow-hidden  text-center ">
                        ...
                        <div class="text-left px-3 mt-3 leading-relaxed">
                            ...
                            Navigating complex regulatory pathways for CNS therapies.
                            </span>
                        </div>
    ...
    <section class="flex items-center justify-center  pt-16 pb-16 mb-8">
        <div class="bg-white py-12">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-5xl lg:text-center flex flex-col justify-center items-center">
                    <h2 class="text-base leading-7 text-blue-100 bg-blue-800 p-3 w-1/2 text-center text-white font-bold rounded-lg uppercase mb-4 lg:mb-8">
                        Why Choose Eric Solutions</h2>
                    <h1 class="lg:text-7xl text-4xl md:text-5xl font-bold tracking-tight text-gray-900 text-center">Deep Scientific Knowledge
                    </h1>
                    <p class="mt-6 leading-relaxed text-gray-600 max-w-lg text-center">Expertise in the pathophysiology of CNS disorders and emerging treatment modalities.</p>
                </div>
                    ...
                    <div class="relative flex flex-col items-center justify-center bg-gray-100 rounded-lg p-4 mr-3 mt-3">
                            <dt class="flex flex-col items-center justify-center text-base font-semibold leading-7 text-gray-900">
                                ...
                                <svg fill="#fff" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M256 291.6v409.6l230 51.2V342.8zm512 0v409.6l-230 51.2V342.8z" />
                                    </svg>
                                   
                                </div>Deep Scientific Knowledge
                            </dt>
                            <dd class="mt-2 text-base leading-relaxed text-gray-600 container">Expertise in the pathophysiology of CNS disorders and emerging treatment modalities.</dd>
                        </div>
                        <div class="relative flex flex-col items-center justify-center bg-gray-100 rounded-lg p-4 mr-3 mt-3">
                            <dt class="flex flex-col items-center justify-center text-base font-semibold leading-7 text-gray-900">
                            ...
                            <dd class="mt-2 text-base leading-relaxed text-gray-600 container">Access to diverse patient populations and specialized research sites.</dd>
                        </div>
                        <div class="relative flex flex-col items-center justify-center bg-gray-100 rounded-lg p-4 mr-3 mt-3">
                            <dt class="flex flex-col items-center justify-center text-base font-semibold leading-7 text-gray-900">
                                <div class="flex h-12 w-12 p-3 items-center justify-center rounded-lg bg-blue-800 mb-4">
                                ...
                                </div>Innovative Solutions
                            </dt>
                            <dd class="mt-2 text-base leading-relaxed text-gray-600 container">Incorporating Artificial Intelegence and machine learning for data analysis and trial optimization.</dd>
                        </div>
