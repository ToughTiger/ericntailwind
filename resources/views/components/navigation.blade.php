        ...
        <div>
            <ul class="mobile-menu">
                <li class="mb-1 menu-item-has-children rounded-xl">
                    <a class="block p-4 text-lg font-semibold text-blueGray-500 hover:bg-blue-50 hover:text-blue-500 rounded-xl" href="#">Therapeutics</a>
                </li>
                <li class="mb-1 menu-item-has-children rounded-xl">
                    <a class="block p-4 text-lg font-semibold text-blueGray-500 hover:bg-blue-50 hover:text-blue-500 rounded-xl" href="#">Solutions</a>
                    <ul class="dropdown pl-5">
                        <li>
                            <a href="/clinical_operation" class="menu-sub-item text-sm text-white hover:text-blueGray-500">Clinical Operation & Project Management</a>
                        </li>
                        <li>
                            <a href="/biostatistics" class="menu-sub-item text-sm text-white hover:text-blueGray-500">Biostatistics</a>
                        </li>
                        <li>
                            <a href="/clinical_data" class="menu-sub-item text-sm text-white hover:text-blueGray-500">Clinical Data Standard</a>
                        </li>
                        <li>
                            <a href="/data_management" class="menu-sub-item text-sm text-white hover:text-blueGray-500">Data Management</a>
                        </li>
                        <li>
                            <a href="/pharmacovigilance" class="menu-sub-item text-sm text-white hover:text-blueGray-500">Pharmacovililance</a>
                        </li>
                        <li>
                            <a href="/medical_writing" class="menu-sub-item text-sm text-white hover:text-blueGray-500">Medical Writing</a>
                        </li>
                    </ul>
                </li>
                <li class="mb-1 menu-item-has-children rounded-xl">
                    <a class="block p-4 text-lg font-semibold text-blueGray-500 hover:bg-blue-50 hover:text-blue-400" href="#">Technologies</a>
                    <ul class="dropdown pl-5">
                        <li>
                            <a href="/ctms" class="menu-sub-item text-sm text-white hover:text-blueGray-500">CTMS</a>
                        </li>
                        <li>
                            <a href="/edc" class="menu-sub-item text-sm text-white hover:text-blueGray-500">EDC</a>
                        </li>
                        <li>
                            <a href="/irt" class="menu-sub-item text-sm text-white hover:text-blueGray-500">IWRS</a>
                        </li>
                        <li>
                            <a href="/etmf_tech" class="menu-sub-item text-sm text-white hover:text-blueGray-500">eTMF</a>
                        </li>
                ...
                <li class="mb-1 menu-item-has-children rounded-xl">
                    <a class="block p-4 text-lg font-semibold text-blueGray-500 hover:bg-blue-50 hover:text-blue-500" href="#">Company</a>
                    <ul class="dropdown pl-5">
                        <li>
                            <a href="/about" class="block p-3 text-sm text-white hover:bg-blue-50 hover:text-blue-500">About Eric Solution</a>
                        </li>
                        <li>
                            <a href="/team" class="block p-3 text-sm text-white hover:bg-blue-50 hover:text-blue-500">Team</a>
                        </li>

                    </ul>
                </li>
                <li class="mb-1 menu-item-has-children rounded-xl">
                    <a class="block p-4 text-lg font-semibold text-blueGray-500 hover:bg-blue-50 hover:text-blue-500" href="#">Insight</a>
                    <ul class="dropdown pl-5">
                        <li>
                            <a href="/posts" class="block p-3 text-sm text-white hover:bg-blue-50 hover:text-blue-500">Blog</a>
                        </li>
                        <li>
                            <a href="/case-studies" class="block p-3 text-sm text-white hover:bg-blue-50 hover:text-blue-500">Case Studies</a>
                        </li>
                ...
                <li class="mb-1">
                    <a class="block p-4 text-lg font-semibold text-blueGray-500 hover:bg-blue-50 hover:text-blue-500" href="/contact">Contact Us</a>
                </li>
            </ul>
